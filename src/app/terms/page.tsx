    ...
    <>
      ...
      <div className="legal-container">
        ...
        <div className="legal-section">
          ...
          <ol>
            <li>이용자는 부트캠프 그룹 인원 편성(그룹 배정) 전까지 전액 환불을 요청할 수 있습니다.</li>
            <li><strong>부트캠프 그룹 인원 편성이 완료된 이후에는 환불이 불가합니다.</strong> 본 서비스는 소수 인원 기반의 그룹 부트캠프로 운영되며, 그룹 편성 이후 1인의 이탈은 다른 참여자 전원의 학습 환경과 부트캠프 진행에 직접적이고 회복 불가능한 영향을 미칩니다. 이에 따라 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항 제5호(용역의 제공이 개시된 경우) 및 동법 시행령 제21조에 근거하여 청약 철회가 제한됩니다.</li>
            <li>그룹 편성 완료 시점은 회사가 이용자에게 부트캠프 그룹 배정 안내(단톡방 초대, 그룹 안내 메시지 등)를 발송한 시점으로 합니다.</li>
