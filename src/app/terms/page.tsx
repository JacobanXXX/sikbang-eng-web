    ...
    <>
      ...
      <div className="legal-container">
        ...
        <div className="legal-section">
          <h2>제2조 (정의)</h2>
          <ol>
            <li>&quot;서비스&quot;란 회사가 sikbang.co 웹사이트 및 관련 플랫폼을 통해 제공하는 OPIC 영어 부트캠프, 무료 강의, 뉴스레터, AI 스피킹 연습 등 일체의 온라인 교육 서비스를 말합니다.</li>
            <li>&quot;이용자&quot;란 본 약관에 따라 회사가 제공하는 서비스를 이용하는 자를 말합니다.</li>
            <li>&quot;유료 서비스&quot;란 회사가 유료로 제공하는 부트캠프 프로그램, 코스 등을 말합니다.</li>
        ...
        <div className="legal-section">
          ...
          <ol>
            <li>회사는 다음과 같은 서비스를 제공합니다:
              <ul>
                <li>OPIC 대비 14일 집중 부트캠프 프로그램</li>
        ...
        <div className="legal-section">
          ...
          <ol>
            ...
            <li>유료 서비스의 이용 기간은 해당 부트캠프 프로그램에 명시된 기간으로 한정되며, 기간 종료 후 서비스가 자동으로 종료됩니다. 기간 연장은 회사의 별도 안내에 따릅니다.</li>
          </ol>
        </div>
        ...
        <div className="legal-section">
          ...
          <ol>
            <li>이용자는 부트캠프 그룹 인원 편성(그룹 배정) 전까지 교재비를 제외한 전액의 환불을 요청할 수 있습니다.</li>
            <li><strong>1차 1대1 피드백 진행 후 환불 요청 시(통상 부트캠프 시작일 기준 Day 1~Day 3 이내)</strong>, 코칭 비용을 환불해드립니다. 단, 이미 사용된 교재비 및 SpeakCoach AI 이용료는 차감됩니다.</li>
            <li><strong>1차 1대1 피드백 진행 이후에는 환불이 불가합니다.</strong> 본 서비스는 소수 인원 기반의 그룹 부트캠프로 운영되며, 1차 피드백 시점 이후 1인의 이탈은 다른 참여자 전원의 학습 환경과 부트캠프 진행에 직접적이고 회복 불가능한 영향을 미칩니다. 이에 따라 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항 제5호(용역의 제공이 개시된 경우) 및 동법 시행령 제21조에 근거하여 청약 철회가 제한됩니다.</li>
            <li>본 약관에서 "용역 제공의 개시"는 1차 1대1 피드백이 진행된 시점을 의미합니다. 그룹 편성(단톡방 초대) 시점은 부트캠프 진행 준비 단계로 간주합니다.</li>
            <li>이용자는 결제 시 1차 피드백 이후 환불이 불가하다는 점을 충분히 고지받으며, 결제 완료를 통해 이에 동의한 것으로 간주합니다.</li>
            <li>다음 각 호에 해당하는 경우에도 환불이 불가합니다:
              <ul>
                <li>부트캠프 진행 중 연락 두절(부트캠프 초대 무시, 단톡방 미참여 등), 무단 불참 등으로 다른 참여자에게 피해를 주는 행위가 확인된 경우</li>
                <li>부트캠프 일정 조율 등 운영에 필요한 연락에 48시간 이상 미응답이 2회 이상 반복되는 경우</li>
                <li>이용자가 본 약관 제8조에 규정된 의무를 위반하여 서비스 이용이 제한된 경우</li>
              </ul>
            </li>
            <li>회사의 귀책사유(서비스 미제공, 부트캠프 미진행 등)로 인한 경우에는 전액 환불합니다.</li>
          ...
          <ol>
            <li>이용자는 서비스 이용 시 다음 행위를 하여서는 안 됩니다:
              <ul>
                ...
                <li>부트캠프 그룹 내에서 욕설, 비방, 성희롱 등 부적절한 언행을 하는 행위</li>
          ...
          <ol>
            ...
            <li>회사는 다음 각 호에 해당하는 경우 사전 통보 없이 서비스 이용을 즉시 제한할 수 있습니다:
              <ul>
                ...
                <li>부트캠프 운영에 중대한 지장을 초래하는 행위가 반복되는 경우</li>
              </ul>
            </li>
        ...
        <div className="legal-section">
          ...
          <ol>
            ...
            <li>이용자가 부트캠프 그룹 내 다른 이용자와의 관계에서 발생한 분쟁에 대해 회사는 중재 의무를 지지 않으며, 책임을 부담하지 않습니다.</li>
          </ol>
        </div>
