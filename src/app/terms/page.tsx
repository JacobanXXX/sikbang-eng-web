    ...
    <>
      ...
      <div className="legal-container">
        ...
        <div className="legal-section">
          ...
          <ol>
            <li>이용자는 「전자상거래 등에서의 소비자보호에 관한 법률」에 따라 서비스 구매일로부터 7일 이내에 청약 철회를 할 수 있습니다.</li>
            <li>다만, 다음 각 호에 해당하는 경우 청약 철회가 제한됩니다:
              <ul>
                <li>스터디 그룹 배정이 완료되어 서비스 제공이 개시된 경우 (그룹 기반 맞춤형 서비스의 특성상 다른 참여자에게 직접적 영향을 미치므로)</li>
                <li>스터디 단톡방 초대 등 서비스 이용을 위한 디지털 콘텐츠 제공이 시작된 경우</li>
                <li>이용자의 책임 있는 사유로 서비스가 멸실 또는 훼손된 경우</li>
              </ul>
            </li>
            <li>스터디 시작일 이전이라도 그룹 매칭이 완료된 이후에는 다른 참여자의 학습 환경에 영향을 미치므로, 결제 금액의 10%에 해당하는 위약금을 공제한 후 환불합니다.</li>
            <li>스터디 시작 이후 이용자 사유로 인한 중도 해지 시, 잔여 기간에 대한 환불 금액은 다음과 같이 산정합니다: 환불 금액 = 결제 금액 - (총 서비스 기간 중 경과 일수에 해당하는 금액) - (결제 금액의 10%에 해당하는 위약금)</li>
            <li>다음 각 호에 해당하는 경우 환불이 불가합니다:
              <ul>
                ...
                <li>스터디 전체 기간의 50% 이상이 경과한 시점 이후의 환불 요청</li>
              </ul>
            </li>
            <li>이용자는 유료 서비스 결제 시 위 환불 제한 조건에 동의한 것으로 간주하며, 결제 과정에서 해당 내용을 고지합니다.</li>
